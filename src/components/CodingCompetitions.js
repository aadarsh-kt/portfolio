...
const projects = [
  {
    ...
    description:
      "CRUD functionality for companies to register for college placements",
  ...
  },
  {
    ...
    description:
      "Co-developed UI for a website to detect solare flare in x-ray data.",
  ...
  },
  {
    ...
    name: "Eloquence",
    description:
      "an app to make it easy to learn new words using flash cards",
  ...
  },
  {
    ...
    name: "MY FI",
    description:
      " an app that saves personal income and expenditures and shows them using circular graphs.",
...
const CodingCompetitions = () => {
  return (
    <div className="flex flex-col w-full h-full">
      <p className="lg:text-5xl text-3xl xl:text-6xl font-[poppins] font-semibold">
        Sport Programming
      </p>
