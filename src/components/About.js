...
const About = () => {
  return (
    <div className='flex flex-col'>
        <p className='text-3xl lg:text-5xl xl:text-6xl text-gray-800 font-[poppins] font-semibold'>About</p>
          ...
          >
            ...
            <div className='flex bg-white lg:w-1/2 w-full rounded-3xl p-10 m-10 shadow-xl'>
                <p className='lg:text-xl xl:text-2xl text-gray-800 font-[poppins] font-light'>
                    Welcome to my portfolio, I am <b>Aadarsh Kumar Tiwari</b>, 3rd year student at <b>IIT(ISM) Dhanbad</b>.
                    <br />  
                    <br />
